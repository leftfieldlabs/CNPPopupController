...
@property (nonatomic, assign) CGFloat blurEffectAlpha; // Alpha of blur effect
@property (nonatomic, assign) CGFloat blurEffectDuration; // length of animation enabling blue effect
